...
public class InstanceImpl implements MultiLabelInstance {
    ...
    protected long instanceTimeStamp;
    ...
    public InstanceImpl(InstanceImpl inst) {
        ...
        this.instanceTimeStamp=inst.instanceTimeStamp;
    }
	...
	@Override
	public void setInstanceTimeStamp(double instanceTimeStamp) {
		this.instanceTimeStamp= (long) instanceTimeStamp;
